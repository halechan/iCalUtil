...
{ICAL_EQUIVALENTTZID_PROPERTY,"EQUIVALENT-TZID",ICAL_TEXT_VALUE},
...
icalproperty* icalproperty_vanew_equivalenttzid(const char* v, ...){
   va_list args;
   struct icalproperty_impl *impl;
   icalerror_check_arg_rz( (v!=0),"v");

   impl= icalproperty_new_impl(ICAL_EQUIVALENTTZID_PROPERTY);
   icalproperty_set_equivalenttzid((icalproperty*)impl,v);
   va_start(args,v);
   icalproperty_add_parameters(impl, args);
   va_end(args);
   return (icalproperty*)impl;
...
/* EQUIVALENT-TZID */
icalproperty* icalproperty_new_equivalenttzid(const char* v) {
   struct icalproperty_impl *impl;
   icalerror_check_arg_rz( (v!=0),"v");
...
void icalproperty_set_equivalenttzid(icalproperty* prop, const char* v){
    icalerror_check_arg_rv( (v!=0),"v");

    icalerror_check_arg_rv( (prop!=0),"prop");
    icalproperty_set_value(prop,icalvalue_new_text(v));
}
const char* icalproperty_get_equivalenttzid(const icalproperty* prop){
    icalerror_check_arg( (prop!=0),"prop");
    return icalvalue_get_text(icalproperty_get_value(prop));
}
