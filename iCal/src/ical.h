...
typedef enum icalproperty_kind {
    ...
    ICAL_EQUIVALENTTZID_PROPERTY = 108, 
...
const char* icalproperty_get_equivalenttzid(const icalproperty* prop);icalproperty* icalproperty_vanew_equivalenttzid(const char* v, ...);
